...
const core = {
    ...
    rewriteAssetUrls: require('../../services/B2AssetService').rewriteAssetUrls,
...
const path = require('path');
        this.chunk = core.rewriteAssetUrls(core.loadJsonFile('nohud/chunk.json', path.join(__dirname, '../../../database/data/nohud/chunk.json')));
