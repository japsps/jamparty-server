...
const { rewriteAssetUrls } = require('./services/B2AssetService');
...
// If B2 proxy settings are present, make every configured source URL point to
// this server before the per-platform song databases are generated.
songdb.db = rewriteAssetUrls(songdb.db);
main.songdb = songdb.generateSonglist();
Object.assign(main, rewriteAssetUrls(main));
